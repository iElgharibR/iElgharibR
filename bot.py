...
# --- الإعدادات الأساسية ---
TOKEN = "7277206485:AAHex8YVogtsTHuPyqfwXflxgk4URL7qnEM"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # دعم الرسائل المعدلة والرسائل العادية
...
def main():
    ...
    application.add_handler(MessageHandler(filters.TEXT & filters.UpdateType.EDITED_MESSAGE, handle_message))  # أضف هذا السطر
